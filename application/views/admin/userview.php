		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item">
						<a href="<?php echo base_url()?>Dashboardadmin/viewuser" class="nav-link active">
									...
									<table border="1">
										...
										{?>
											<tr>
												...
												<td> <a href="<?php echo base_url();?>Dashboardadmin/viewupdateuser?userid=<?php echo $user->id?>"><button class="btn btn-block btn-primary">Update</button></a> </td>
												<td> <a href="<?php echo base_url();?>Dashboardadmin/updateuserstatus?userid=<?php echo $user->id?>&status=<?php echo $user->status?>"><button class="btn btn-block btn-primary"><?php if($user->status=="APPROVED") echo "Block"; else echo "UnBlock"  ?></button></a> </td>
												<td><button class="btn btn-block btn-danger" onclick="deleteitem('<?php echo $user->id?>')">Delete</button></td>
											</tr>
										<?php }?>
...
<script>
	function deleteitem(userid)
	{
		...
		xhttp.open("GET", url + "Dashboardadmin/removeuser?userid=" + userid, true);
