		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item">
						<a href="<?php echo base_url()?>Dashboardadmin/viewproduct" class="nav-link active">
						<i class="fas fa-box-open"></i></i>
							<p>
								View Products
							</p>
									...
									<table border="1">
										...
										{?>
											<tr>
												...
												<td>  <a href="<?php echo base_url();?>Dashboardadmin/viewupdateproduct?productid=<?php echo $product->id?>"><button class="btn btn-block btn-primary"> Update</button></a></td>
												<td><button class="btn btn-block btn-danger" onclick="deleteitem('<?php echo $product->id?>')">Delete</button></td>
												</tr>
										<?php }?>
...
<script>
	function deleteitem(proid)
	{
		...
		xhttp.open("GET", url + "Dashboardadmin/removeproduct?productid=" + proid, true);
