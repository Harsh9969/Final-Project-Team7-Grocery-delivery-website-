									...
									<table border="1">
										...
										{?>
											<tr>
												...
												<td> <a href="<?php base_url()?>orderdetilas?orderid=<?php echo $order->id?>"> <button class="btn btn-block btn-primary">View</button></a></td>
												<td><button class="btn btn-block btn-danger" onclick="deleteitem('<?php echo $order->id?>')">Delete</button></td>
												<td><button class="btn btn-block btn-danger" onclick="updatestatus('<?php echo $order->id?>','Process Warehouse')">Process Warehouse</button></td>
												<td><button class="btn btn-block btn-danger" onclick="updatestatus('<?php echo $order->id?>','Shipment')">Shipment</button></td>
												<td><button class="btn btn-block btn-danger" onclick="updatestatus('<?php echo $order->id?>','Product Delivery')">Product Delivery</button></td>
...
<script>
	function deleteitem(proid)
	{
		...
		xhttp.open("GET", url + "Dashboardadmin/removeorder?productid=" + proid, true);
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		//  xhttp.send("password=" + x.value + "&email=" + z.value);
		xhttp.send();
		}
	}
	function updatestatus(proid,status)
	{
		let url = "<?php echo base_url(); ?>";
		xhttp = new XMLHttpRequest();
		xhttp.onreadystatechange = function() {
		...
		xhttp.open("GET", url + "Dashboardadmin/updateorderstatus?orderid=" + proid+"&status="+status, true);
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		//  xhttp.send("password=" + x.value + "&email=" + z.value);
		xhttp.send();
	}
