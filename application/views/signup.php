						...
						<div class="eflux-login-form-area">
							...
							<form action="" method="POST" class="eflux-login-form">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										...
										<div class="input-item">
											...
											<input type="text" name="add" id="address" placeholder="Address" required/>
									...
									<div class="col-lg-4">
										...
										<div class="input-item">
											...
											<input type="text" name="zpcode" id="zpcode" placeholder="Zipcode" max='6' min='6' required/>
									...
									<div class="col-lg-6">
										...
										<div class="input-item">
											...
											<input type="email" name="email" id="ems" placeholder="Email Address" />
									...
									<div class="col-lg-6">
										...
										<div class="input-item">
											...
											<input type="password" name="password" id="pwds" placeholder="Password" />
								...
								<div>
									...
									<button type="submit" class="btn btn-warning" id="crt">Create Account</button>

									<a href="<?php echo base_url();?>" class="btn btn-warning" id="btnback">Back</a>
